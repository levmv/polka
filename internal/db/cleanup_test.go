...
func TestCleanupCategories(t *testing.T) {
	...
	// Seed authors
	mustExec(t, database, "INSERT INTO authors (id, name, sort_name) VALUES (1, 'Unknown Author', 'Unknown Author')")
	mustExec(t, database, "INSERT INTO authors (id, name, sort_name) VALUES (2, 'Real Author', 'Real Author')")
	...
	mustExec(t, database, "INSERT INTO search (rowid, title, authors, tags, description) VALUES (5, 'B5', 'Unknown Author', 't5', 'd5')")
