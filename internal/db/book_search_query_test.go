...
func TestParseQuery(t *testing.T) {
	tests := []struct {
		...
		{"single alphabetic character uses prefix", "a", `-tag_keys:"a"*`},
		...
		{"trailing qualifier preserves free-text prefix", `fo author:"Isaac Asimov"`, `-tag_keys:"fo"* authors:"Isaac Asimov"`},
		{"qualifier between free-text terms", "foundation author:asi ba", `-tag_keys:"foundation" authors:"asi"* -tag_keys:"ba"*`},
		{"quoted final free-text term stays exact", `fo "base" author:asi`, `-tag_keys:"fo" -tag_keys:"base" authors:"asi"*`},
